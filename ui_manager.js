        ...
        resultsScreen.innerHTML = `
            <div class="results-container">
                ...
                <h1 style="color: var(--gold-light); margin-bottom: 10px;">
                    ${results.isWin ? 'مبروك! لقد فزت!' : 'انتهت اللعبة!'}
                </h1>
                <p style="color: #aaa; margin-bottom: 30px;">
                    ${results.isWin ? 'لقد فزت بمليون دولار!' : 'حاول مرة أخرى للفوز بالمليون!'}
                </p>
...
الوقت: ${Math.floor(results.totalTime / 60)}:${(results.totalTime % 60).toString().padStart(2, '0')}
